                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      elevation: 4,
                      color: Color.fromARGB(255, 255, 157, 108), 
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text('Laporan : ${index + 1}', style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 18, color: const Color.fromARGB(255, 0, 0, 0))),
                                IconButton(
